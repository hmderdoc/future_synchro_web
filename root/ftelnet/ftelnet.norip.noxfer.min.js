...
else if(this._AnsiParserState===AnsiParserState.ReadingStringEscape){if(text.charAt(i)==='\\'){if(Sixel.IsSixel(Buffer)){this._Crt.DrawSixel(Sixel.Decode(Buffer));}
else{console.log('Ansi.ts read string: '+Buffer);}}
...
this._LastTimer=new Date().getTime();};fTelnetClient.prototype.ScheduleDataContinuation=function(){var that=this;if(typeof queueMicrotask==='function'){queueMicrotask(function(){that.OnConnectionData();});}
else{this._DataTimer=setTimeout(function(){that.OnConnectionData();},0);}};fTelnetClient.prototype.FastForward=function(){if(typeof this._Connection==='undefined'){return 0;}
