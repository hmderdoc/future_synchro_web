...
var _forumIconDir = system.mods_dir;
if (_forumIconDir && _forumIconDir.slice(-1) !== '/' && _forumIconDir.slice(-1) !== '\\') _forumIconDir += '/';
_forumIconDir += 'future_shell/assets/';
...
function formatMessage(body, ansi, exascii) {
    ...
    if (typeof ansi === 'boolean' && ansi) {
        ...
        if (body_m !== null) {
            ...
            body = '<pre class="ansi">' + body + line + "</pre>";
        }
